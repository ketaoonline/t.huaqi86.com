...
class SDKConfig {
	...
	function __construct(){
		...
		$backUrl = __URL(__URL__ . '/wap/Pay/payNotify');
		$frontUrl = __URL(__URL__ . '/wap/Pay/payReturn');
		...
		$this->signCertPath = $config['certs_path'] . 'acp_private.pfx';
		...
		$this->encryptCertPath = $config['certs_path'] . 'acp_prod_enc.cer';
		$this->rootCertPath = $config['certs_path'] . 'acp_prod_root.cer';
		$this->middleCertPath =   $config['certs_path'] . 'acp_prod_middle.cer';
