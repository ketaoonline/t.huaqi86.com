...
class Events
{
    ...
    public function clearGoodsPoster(){
        try {
            NiuDelDir(ROOT_PATH.'upload/goods_poster');
            NiuDelDir(ROOT_PATH.'upload/uniapp_goods_poster');
            NiuDelDir(ROOT_PATH.'upload/applet_goods_poster');
            return true;
        } catch (\Exception $e) {
            return false;
        }
