	...
	switch (type) {
		case "password":
			...
			if(newpassword.length == 0){
				toast(lang_member_info.member_enter_new_password);
				return false;
			}
			...
			if(oldpassword == newpassword){
				toast(lang_member_info.newpassword_oldpassword_nosame);
				return false;
			}
			if(newpassword2.length == 0){
				toast(lang_member_info.please_enter_confirmation_password);
				return false;
			}
