...
class Promotion extends BaseController
{
	...
	public function addOrEditComboPackage()
	{
		...
		$sku_id_array = request()->post("sku_id_array", "");
		
		$res = $promotionService->addOrEditComboPackage($id, $combo_package_name, $combo_package_price, $goods_id_array, $is_shelves, $this->instance_id, $original_price, $save_the_price, $sku_id_array);
