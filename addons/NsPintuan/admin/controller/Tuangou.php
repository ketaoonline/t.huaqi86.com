...
class Tuangou extends BaseController
{
	...
	public function updateGoodsPintuan()
	{
		if (request()->isAjax()) {
			...
			$sku_json = request()->post('sku_json', '');
			...
			$res = $pintuan->addUpdateGoodsPintuan($tuangou_id, $goods_id, $is_open, $is_show, $tuangou_money, $tuangou_num, $tuangou_time, $tuangou_type, $tuangou_content_json, $remark, $sku_json);
			$code_message = "";
			if($res["code"] <= 0){
