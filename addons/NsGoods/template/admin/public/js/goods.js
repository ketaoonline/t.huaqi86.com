...
function ValidateUserInput() {
	...
	// 总库存
	//alert(IsPositiveNum("#txtProductCount"));return false;
//	if (!IsPositiveNum("#txtProductCount")) {
	if ($("#txtProductCount").val() == '0' || $("#txtProductCount").val()=='') {
		$(".goods-nav ul li:eq(0)").click();
	...
	var all = parseFloat($('.block-fx-setting [name="distribution_commission_rate"]').val()) + parseFloat($('.block-fx-setting [name="partner_commission_rate"]').val()) + parseFloat($('.block-fx-setting [name="distribution_team_commission_rate"]').val()) + parseFloat($('.block-fx-setting [name="partner_team_commission_rate"]').val()) + parseFloat($('.block-fx-setting [name="regionagent_commission_rate"]').val()) + parseFloat($('.block-fx-setting [name="channelagent_commission_rate"]').val());
	if(all > 100){
...
function PackageProductInfo() {
	...
	// 分销设置
	obj.fxSetting = {
		is_open : $('.block-fx-setting [name="is_open"]').is(':checked') ? 1 : 0,
		distribution_commission_rate : $('.block-fx-setting [name="distribution_commission_rate"]').val(),
		regionagent_commission_rate : $('.block-fx-setting [name="regionagent_commission_rate"]').val(),
		partner_commission_rate : $('.block-fx-setting [name="partner_commission_rate"]').val(),
		distribution_team_commission_rate : $('.block-fx-setting [name="distribution_team_commission_rate"]').val(),
		partner_team_commission_rate : $('.block-fx-setting [name="partner_team_commission_rate"]').val(),
		channelagent_commission_rate : $('.block-fx-setting [name="channelagent_commission_rate"]').val()
	}
