...
class NsUnionPayAddon extends \addons\Addons
{
    ...
    public function checkPayTypeConfig($param){
        ...
        $msg = "";
        if (empty($pay_info) || empty($pay_info['value']['sign_cert_pwd']) || empty($pay_info['value']['certs_path']) || empty($pay_info['value']['log_path']) || empty($pay_info['value']['merchant_number'])) {
