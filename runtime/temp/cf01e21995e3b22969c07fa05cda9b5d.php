<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:43:"template/admin/Order/orderRefundAction.html";i:1588918383;}*/ ?>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<p class="tips-cont">退款金额将优先退还到余额，剩余部分将按您选择的退款方式退还</p>
				<div class="refunds-block">
					<label>退款金额：</label>
...
function refuseRefundType(type){
	...
	if(type == 1){
		refund_url = "<?php echo __URL('http://t.huaqi86.com/index.php/admin/order/ordergoodsrefuseonce'); ?>";
	} else{
		refund_url = "<?php echo __URL('http://t.huaqi86.com/index.php/admin/order/ordergoodsrefuseforever'); ?>";
	}
	$.ajax({
		type : "post",
		url : refund_url,
...
function orderGoodsConfirmRecieve(order_id,order_goods_id){
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('http://t.huaqi86.com/index.php/admin/order/getOrderGoodsDetialAjax'); ?>",
...
function confirm_receipt(){
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('http://t.huaqi86.com/index.php/admin/order/ordergoodsconfirmrecieve'); ?>",
