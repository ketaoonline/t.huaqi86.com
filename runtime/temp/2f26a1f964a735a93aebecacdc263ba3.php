<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"template/web/default/goods/discount.html";i:1566802326;s:57:"/www/wwwroot/t.huaqi86.com/template/web/default/base.html";i:1587364095;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<link type="text/css" rel="stylesheet" href="/template/web/default/public/css/goods_discount.css">
	...
	<div id="banner" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			...
			<div class="item <?php if($k==0): ?>active<?php endif; ?>" style="background-color:<?php echo $vo['background']; ?>">
				...
				<?php else: ?>
					<a href="<?php echo __URL('http://t.huaqi86.com/index.php'.$vo['adv_url']); ?>" target="_blank" style="width: <?php echo $banner_list['data']['ap_width']; ?>px;height: <?php echo $banner_list['data']['ap_height']; ?>px;line-height: <?php echo $banner_list['data']['ap_height']; ?>px;">
				<?php endif; ?>
...
$total_count = $discount_list['total_count'];
 if(!(empty($discount_list['data']) || (($discount_list['data'] instanceof \think\Collection || $discount_list['data'] instanceof \think\Paginator ) && $discount_list['data']->isEmpty()))): ?>
<ul class="product-list clearfix" id="product_list">
	<?php if(is_array($discount_list['data']) || $discount_list['data'] instanceof \think\Collection || $discount_list['data'] instanceof \think\Paginator): $i = 0; $__LIST__ = $discount_list['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
	<li class="ns-border-color">
		<a href="<?php echo __URL('http://t.huaqi86.com/index.php/goods/detail','goods_id='.$vo['goods_id']); ?>" target="_blank" title="<?php echo $vo['goods_name']; ?>" class="link">
			<?php if($vo['pic_cover_mid']): ?>
			<img alt="轮播图" src="<?php echo __IMG($vo['pic_cover_mid']); ?>">
			<?php else: ?>
			<img alt="轮播图" src="/template/web/default/public/img/discount_product_default.png">
			<?php endif; ?>
		...
		<div class="info start ns-border-color">
			<div>
				<div class="price">
					<i class="ns-text-color"><?php echo $vo['display_price']; ?></i>
					<span>￥<?php echo $vo['price']; ?></span>
				</div>
				<div class="tip">限时秒杀 抢先提醒</div>
			</div>
			<a href="<?php echo __URL('http://t.huaqi86.com/index.php/goods/detail','goods_id='.$vo['goods_id']); ?>" target="_blank">
...
<ul class="pager" data-ride="pager" data-elements="prev,nav,next,total_page_text,goto" data-rec-per-page="<?php echo $page_size; ?>" data-page="<?php echo $page; ?>" data-rec-total="<?php echo $total_count; ?>" id="my_pager"></ul>
<?php else: ?>
...
$('#my_pager').pager({
	linkCreator: function(page, pager) {
		return __URL("http://t.huaqi86.com/index.php/goods/discount?page="+page);
	}
});
</script>
