...
<script>
	function addPromoterLevel(){
		...
		$.ajax({
			type:"post",
			url:"<?php echo __URL('http://t.huaqi86.com/index.php/nsfx/admin/Distribution/addPromoterLevel'); ?>",
			data:{
