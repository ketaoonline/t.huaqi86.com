...
<div class="options-btn">
	<?php if($shop_config_info['is_regional_agent'] == 1): ?> 
		<a id="is_regional_agent" class="btn-common" href="javascript:openRegionalAgent(0)" >关闭区域分销(开启中)</a>
	<?php else: ?>
		<a id="is_regional_agent" class="btn-common-white" href="javascript:openRegionalAgent(1)" >开启区域分销(关闭中)</a>
	<?php endif; ?>
</div>
<div class="set-style">
<!-- 	<dl>
			...
			<table class="table-class">
				...
				<tbody  id="partner_global">
				    ...
				    <tr align="center" >
						<td>省级代理</td>
						<td>
							<input  class="input-common harf" type="text" id="province_rate" value="<?php echo $region_agent_info['province_rate']; ?>" /><em class="unit">%</em>
						</td>
						<td>
							<input  class="input-common harf"  type="text" id="application_require_province" value="<?php echo $region_agent_info['application_require_province']; ?>" /><em class="unit">元</em>
						</td>						
					</tr>					
					<tr align="center" >
						<td>市级代理</td>
						<td>
							<input  class="input-common harf" type="text" id="city_rate" value="<?php echo $region_agent_info['city_rate']; ?>" /><em class="unit">%</em>
						</td>
						<td>
							<input  class="input-common harf"  type="text" id="application_require_city" value="<?php echo $region_agent_info['application_require_city']; ?>" /><em class="unit">元</em>
						</td>						
					</tr>
					<tr align="center" >
						<td>区级代理</td>
						<td>
							<input  class="input-common harf" type="text" id="district_rate" value="<?php echo $region_agent_info['district_rate']; ?>" /><em class="unit">%</em>
						</td>
						<td>
							<input  class="input-common harf"  type="text" id="application_require_district" value="<?php echo $region_agent_info['application_require_district']; ?>" /><em class="unit">元</em>
						</td>						
					</tr>
				</tbody>
			</table>
...
<script src="/public/static/js/limit_input_digit.js"></script>
<script>		
	function modifyShopConfigIsRegionalAgent(){
		...
		$.ajax({
			type:"post",
			url:"<?php echo __URL('http://t.huaqi86.com/index.php/nsfx/admin/Distribution/UpdateShopRegionAgentConfig'); ?>",
			data:{
			...
			success:function (data) {
				if (data["code"] > 0) {
					showMessage('success', data["message"],"<?php echo __URL('http://t.huaqi86.com/index.php/nsfx/admin/Distribution/regionalAgent'); ?>");
				}else{
	...
	function openRegionalAgent(is_open){
		$.ajax({
			type:"post",
			url:"<?php echo __URL('http://t.huaqi86.com/index.php/nsfx/admin/distribution/updatenfxshopconfigfield'); ?>",
			data:{
				'fieldvalue':is_open,
