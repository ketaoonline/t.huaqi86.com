...
<!-- 				<a href="<?php echo __URL('http://t.huaqi86.com/index.php/admin/'.$frist_menu['url']); ?>"><?php echo $frist_menu['module_name']; ?></a> -->
<!-- 				<?php endif; ?> -->
<!-- 				<?php if($secend_menu['module_name'] != ''): ?> -->
<!-- 				<i class="fa fa-angle-right"></i> -->
<!-- 					需要加跳转链接用这个：http://t.huaqi86.com/index.php/admin/<?php echo $secend_menu['url']; ?> -->
...
<div class="goods-prompt">
	...
	<div class="goods-state a-line">
		<ul>
			<li>
				<a href="<?php echo __URL('http://t.huaqi86.com/index.php/admin/goods/goodslist'); ?>">
					<strong class="goods_sale_count">0</strong>
					<span>出售中</span>
				</a>
			</li>
			<li>
				<a href="<?php echo __URL('http://t.huaqi86.com/index.php/admin/goods/goodslist','state_type=2'); ?>">
					<strong class="goods_audit_count">0</strong>
					<span>仓库中</span>
				</a>
			</li>
			<li>
				<a href="<?php echo __URL('http://t.huaqi86.com/index.php/admin/saleservice/consultlist?type=to_reply'); ?>">
					<strong class="goods_consult_count">0</strong>
					<span>待回复咨询</span>
				</a>
			</li>
			<li>
				<a href="<?php echo __URL('http://t.huaqi86.com/index.php/admin/member/usercommissionwithdrawlist'); ?>">
					<strong class="member_balance_withdraw">0</strong>
					<span>会员提现审核</span>
				</a>
			</li>
			<li>
				<a href="<?php echo __URL('http://t.huaqi86.com/index.php/admin/goods/goodslist','stock_warning=1'); ?>">
...
<div class="merchants-help">
	...
	<div class="merchants-use">
		<ul>
			...
			<li>
				<a href="<?php echo __URL('http://t.huaqi86.com/index.php/admin/extend/addonslist'); ?>">
			...
			<li>
				...
				<a href="<?php echo __URL('http://t.huaqi86.com/index.php/NsPintuan/admin/tuangou/pintuanlist'); ?>">
			...
			<li>
				...
				<a href="<?php echo __URL('http://t.huaqi86.com/index.php/NsBargain/admin/bargain/index'); ?>">
			...
			<li>
				...
				<a href="<?php echo __URL('http://t.huaqi86.com/index.php/Nsfx/admin/Distribution/promoterList'); ?>">
			...
			<li>
				...
				<a href="<?php echo __URL('http://t.huaqi86.com/index.php/NsAnalysis/admin/account/shopgoodssaleslist'); ?>">
...
<div class="goods-prompt">
	...
	<div class="goods-state a-line order">
		<ul>
			<li>
				<a href="<?php echo __URL('http://t.huaqi86.com/index.php/admin/order/orderlist?status=0'); ?>">
					<strong class="daifukuan">0</strong>
					<span>待付款</span>
				</a>
			</li>
			<li>
				<a href="<?php echo __URL('http://t.huaqi86.com/index.php/admin/order/orderlist?status=1'); ?>">
					<strong class="daifahuo">0</strong>
					<span>待发货</span>
				</a>
			</li>
			<li>
				<a href="<?php echo __URL('http://t.huaqi86.com/index.php/admin/order/orderlist?status=2'); ?>">
					<strong class="yifahuo">0</strong>
					<span>已发货</span>
				</a>
			</li>
			<li>
				<a href="<?php echo __URL('http://t.huaqi86.com/index.php/admin/order/orderlist?status=3'); ?>">
					<strong class="yishouhuo">0</strong>
					<span>已收货</span>
				</a>
			</li>
			<li>
				<a href="<?php echo __URL('http://t.huaqi86.com/index.php/admin/order/orderlist?status=4'); ?>">
					<strong class="yiwancheng">0</strong>
					<span>已完成</span>
				</a>
			</li>
			<!-- <li>
				<a href="<?php echo __URL('http://t.huaqi86.com/index.php/admin/order/orderlist?status=5'); ?>">
			...
			<li>
				<a href="<?php echo __URL('http://t.huaqi86.com/index.php/admin/order/customerServiceList'); ?>">
	...
	<table>
		...
		<tr>
			...
			<td title="<?php echo $goods_info['goods_name']; ?>" style="text-align: left;">
				<a href="<?php echo __URL('http://t.huaqi86.com/index.php/goods/detail','goods_id='.$goods_info['goods_id']); ?>" target="_blank"><?php echo strlen($goods_info["goods_name"])>20 ? mb_substr($goods_info["goods_name"],0,20,'utf-8')."...":$goods_info["goods_name"]; ?></a>
			</td>
			<td>
				<?php if($key == 0): ?>
				<span class="frist">
