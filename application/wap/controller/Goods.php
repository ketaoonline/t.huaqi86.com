...
//		优先商品预售
	...
	{
	    // 获取自定义模板信息
	    $custom_template = arrayFilter(hook('diyview', ['template_type' => 'category']));
	...
	public function topicDetail()
	{
		...
		if (empty($topic_goods)) $this->error("没有获取到专题信息");
	      
		$this->assign('info', $topic_goods);
		$this->assign('title', $topic_goods['topic_name']);
		$this->assign("title_before", $topic_goods['topic_name']);
