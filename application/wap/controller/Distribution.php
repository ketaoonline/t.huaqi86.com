...
class Distribution extends BaseWap
{
	...
	public function toWithdraw()
	{
		...
		$this->assign("flag", request()->get("flag", "")); 
	...
	{
		$this->assign("title_before", "推荐商品");
		$this->assign("title", "推荐商品");
	...
	{
		$this->assign("title_before", "我的推荐商品");
		$this->assign("title", "我的推荐商品");
		$this->assign('category_id', request()->get('category_id', ''));
	...
	{
		$this->assign("title_before", "分销商等级");
		$this->assign("title", "分销商等级");
		return $this->view($this->style . "/distribution/member_level");
	}
