...
class Express extends BaseController
{
	...
	public function getOrderShipping(){
		...
		return $express_list_pagequery;
	}
	
	/**
	 * 物流公司编码
	 */
	public function expressCompanyCode(){
	    $filename = "./template/admin/public/expresscompanycode.json";
        $string = file_get_contents($filename);
        $express_company_code = json_decode($string,true);
        $this->assign('express_company_code', $express_company_code);
        return view($this->style . 'Express/expressCompanyCode');
	}
